...
import { PueCalculator } from '@/labs/PueCalculator'
import { FatTreeVis } from '@/labs/FatTreeVis'
import { VmLiveMigration } from '@/labs/VmLiveMigration'
  ...
  return (
    <div>
      ...
      <p className="page-subtitle">
        Esperimenti pratici sui concetti centrali del corso.
      </p>
        ...
        {LABS.map((lab) => (
          ...
          >
            ...
            <div className="muted" style={{ fontSize: 12, marginTop: 12 }}>
              ...
              {LESSONS_BY_SLUG[lab.lessonSlug]?.title ?? lab.lessonSlug}
            </div>
          </Link>
        ))}
      </div>
...
export function LabPage() {
  ...
  switch (lab.slug) {
    ...
    case 'fat-tree-vis':
      return <FatTreeVis />
    case 'vm-live-migration':
      return <VmLiveMigration />
    default:
